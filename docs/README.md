...
**Build-ready gate:** every in-scope concern at contract-grade and published. The six Core concerns are at contract-grade (2026-09-17, still draft); the four remaining are at sketch. Next: `doc-levelup` Security → Governance → Integrations → Business & Legal.
