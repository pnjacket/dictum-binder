...
|---|---|---|---|---|
| Product & Requirements | yes | [product-and-requirements.md](product-and-requirements.md) | specified | contract-grade |
...
**Build-ready gate:** every in-scope concern at contract-grade and published. Product & Requirements is at specified (2026-09-17); the rest are at sketch. Next: `doc-levelup` in dependency order — Product to contract-grade, then Domain & Data / Architecture → Interfaces → downstream.
