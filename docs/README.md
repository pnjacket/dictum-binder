...
|---|---|---|---|---|
| Product & Requirements | yes | [product-and-requirements.md](product-and-requirements.md) | sketch | contract-grade |
...
**Build-ready gate:** every in-scope concern at contract-grade and published. Currently none is; next step is `doc-levelup` in dependency order: Product & Requirements → Domain & Data / Architecture → Interfaces → downstream.
